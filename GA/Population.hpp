...
class Population{
public:
	Population(unsigned populationSize): pop(populationSize,(Individual<Ind>*)nullptr), fitness_comulative(populationSize), fitnessSum(0.), fitnessSum_norm(0.), bestRank(0){}
